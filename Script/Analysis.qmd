...
```{r}
mHovering2 <- lme(Hovering ~ Tank + Time + Filter + Order, random = ~1 | Fish, data = data[data$Hovering>0,], weights = varPower(), control = lmeControl(maxIter = 20000), na.action =na.exclude)
