...
mSwimming0 <- lm(Swimming ~ Tank + Time + Filter, data = data)
anova(mSwimming, mSwimming0)

rd <- rpt(julian_departure ~ factor(year)+sex+departure_period+(1|tag_id), grname = "tag_id", data = data, datatype = "Gaussian", nboot = 0, npermut = 0)
print(rd)
```
