...
palette_RP <- c("#E3C9B8", "#89D7F5", "#AEE3B9", "#84A01A","#84B05D", "#6B4940","#6B4921", "#B8B8B8")
...
All fish besides Goblin hovered more in Jar compared to Small.
...
palette_HP <- c("#E3C9B8", "#89D7F5", "#AED3A1","#AEE3B9","#6B4921")
