...
As the 4th axis is difficult to interpret, we could keep 3 easy-interpretable components to explain 57% of the variance. 57% of the variance is not a lot... I thus decided to study behavioural types individually, but tell me if you prefer analyse the PCA components. The advantage of studying behavioural types individually is also to be able to interpret quantitatively the differences between treatments (like said before, 100 sec difference between tank X and tank Y).
