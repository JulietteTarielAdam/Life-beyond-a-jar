...
```{r}
library(factoextra)
(plotPCA1 <- fviz_pca_var(pca, arrowsize = 1.2, 
                          labelsize = 5, 
...
(plotPCA2 <- fviz_pca_var(pca, arrowsize = 1.2, axes = c(3,4),
                          labelsize = 5, 
                          habillage = factor(1:8)) +
  scale_colour_manual(values=palette.beh2, guide="none")+
    theme(title = element_blank(),
...
(plot.tank <- plot1("Tank") + 
   ...
   scale_fill_manual(values = palette,
                     labels = c("Swimming", "Resting", "Hovering", "Stereotypic swimming", "Nest building", "Foraging", "Interation with surface"),
                     name = "Behaviour")+
   ggtitle("A. Tank")+
    theme(theme.new))
