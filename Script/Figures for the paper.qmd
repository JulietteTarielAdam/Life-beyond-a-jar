...
## All behaviours
```{r}
(plotFish <-tf(data, grouping = "Fish", beh.cols, colMeans) %>% 
...
ggsave(plotFish, filename = "Plots/FigFish.png", width = 8.27, height = 6.27)
```

## Each behaviour depending on tank by fish - Panel graphic
